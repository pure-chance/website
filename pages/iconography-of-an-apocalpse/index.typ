...
#show: article.with(
  uri: "iconography-of-an-apocalypse",
...
But this is far from the first time that we’ve considered the end of the world. Ancient Greece, Ancient Egypt, the Norse, etc. also had a concept of the end times. The difference is that those end times were natural, in t were the result of the gods, the fundamental forces of the world. Nowada longer need the gods, we have tactical nukes. We have Deus Ex Machina, god machine.

And the thing about the nuclear bombs is that—like the presence of buses once you started taking them as a child—once you notice them, yo unsee them. They’re _everywhere_.

And nuclear _everything_ has become a part of iconography, of culture, in such a way that its use has mutated from concrete to abstract to somewhere in between.
...
There are a lot of narratives around the end times. It’s perhaps one of the most enduring ideas that humanity has ever conceptualized. Just as there have always been creation myths, there have also been destruction myths. For centuries the end has been either biblical or natural in nature. Not within the hands of man but within the hands of the divine (or nature). As technology progressed, and our ability to self-annihilate ourselves become every closer, this had begun to shift. Works like Orson Welles’ #html.cite[War of the Worlds] describes an end via alien invasion, and H.G Wells' #html.cite[The Shape of Things to Come] describes an end via (pre-nuclear) war. The causes have begun to shift from biblical to secular. We have taken our destruction into our own hands.

But still the bombings of Hiroshima and Nagasaki represent a titanic shift in the imagery of the end times. In the next decades, vast swathes of literature about apocalypse now have nukes as their instruments of death, from #html.cite[On the Beach] (_Stanley Kramer, 1957_), various episodes of #html.cite[The Twilight Zone], #html.cite[Fallout], #html.cite[Adventure Time], #html.cite[The 100], and many more.
...
On the other hand, the idea of gamifying the nuclear war is horrifying. The language of the game is inherently dehumanizing. 1 million deaths is labeled the awesome #quote[megadeath], while 1 million survivors are labeled the banal #quote[survivor]. DEFCON places the player in the position of the state, and not the individual, and the format of a strategy game necessitates a level of detachment from the horrors of their actions. Players are encouraged to think of destruction and protection in utilitarian terms. Enemies defeated and civilians saved. It’s a numbers game.

This utilitarian mindset pervades the game and its players. In forums, the players laud the game, saying #quote[DEFCON was developed not just as a nuclear strategy game, but as a way to send a horrifying message. To make people feel the full awful weight of such skirmishes. And it was ridiculously effective at this.] (#html.cite[artificial, DEFCON Steam Discussion]) In this post, and the subsequent discussion, you notice the way that the message is described in gamified strategy terms. The point that the game is making is that regardless of strategy, it’s impossible not to suffer heavy casualties against other skilled players. Mass death is inevitable. User Ufnu is informative here:
...
#quote(block: true)[
  ...
  In DEFCON you definitely get this depressing feel and the general understanding of the nuclear war implications, but one question remains unanswered. Like #quote[ok, I see that a nuclear war cannot be won against the equal nuclear power, but WHAT IF I am smart enough to get some advantage before starting it?]
